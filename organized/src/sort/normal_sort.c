...
linked_list_t *sorted_merge_name(linked_list_t *a, linked_list_t *b)
{
    ...
    if (my_strcmp(item1->name, item2->name) < 0) {
        a->next = sorted_merge_name(a->next, b);
        return a;
    } else {
        b->next = sorted_merge_name(a, b->next);
        return b;
    }
}
...
linked_list_t *sorted_merge_type(linked_list_t *a, linked_list_t *b)
{
    ...
    if (my_strcmp(item1->type, item2->type) < 0) {
        a->next = sorted_merge_type(a->next, b);
        return a;
    } else {
        b->next = sorted_merge_type(a, b->next);
        return b;
    }
}
...
linked_list_t *sorted_merge_id(linked_list_t *a, linked_list_t *b)
{
    ...
    if (item1->unique_id < item2->unique_id) {
        a->next = sorted_merge_id(a->next, b);
        return a;
    } else {
        b->next = sorted_merge_id(a, b->next);
        return b;
    }
}
